...
class RoleViewModel extends ViewModel{
	public $viewFields = array(
		...
		'user'=>array('name'=>'user_name','status','weixinid','category_id', 'sex', 'address', 'email', 'img', 'telephone','dashboard','extra_position', '_on'=>'user.user_id=role.user_id',  '_type'=>'LEFT'),
