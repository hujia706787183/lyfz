<?php 
    class CustomerModel extends Model{
        ...
        public function isOrdered($customer_id){
        	return !!M('customer')->alias('customer')
        	->join(C('DB_PREFIX').'receivables receivables on receivables.customer_id=customer.customer_id', 'right')
