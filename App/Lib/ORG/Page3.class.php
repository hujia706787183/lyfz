    ...
    protected $config = [
        ...
        'theme' => '           
           <nav class="page" aria-label="Page navigation">
                <span class="span2">共%totalRow% %header% %nowPage%/%totalPage% 页</span>
                <ul class="pagination">                
                    <li>%first%</li>
                    <li>%upPage%</li>
                    <li>%linkPage%</li>
...
'
    ...
    public function show() {
        ...
        */
        ...
        $thego = '<select style="width:auto;display:inline-block;" class="form-control" name="'.$this->varPage.'" onchange="go_page'.$this->varPage.'(this.value)">';
