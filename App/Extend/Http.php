...
class Http {
    ...
    public static function PostForm($url, $params = [], $header = [])
    {
        return self::sendRequest($url, $params, $header);
    }

    public static function urlLongToShort($url)
    {
        return self::PostJson('http://api.t.sina.com.cn/short_url/shorten.json?source=3271760578&url_long='.$url);
    }
}